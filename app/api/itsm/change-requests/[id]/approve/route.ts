...
// POST /api/itsm/change-requests/[id]/approve - Approve a change request
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const allowedRoles = ['change_manager', 'cab_member', 'admin', 'superadmin'];
    ...
    const changeRequest = await changeRequestService.approveChangeRequest(requestId);
